...
$("li#lunch-btn").click(function(){
	...
	$("#food-1 .col-md-8 .card-body .date .text-muted").text("Last updated 11/6/2020")
	...
	$("#food-7 .col-md-8 .card-body .date .text-muted").text("Last updated 10/6/2020")
	...
	$("#food-10 div div img").attr("src", "./img/food/thitkhotrungcut/7.jpg")	
	$("#food-10 div div div a").attr("href","./pages/thitkhotrungcut.html")
	$("#food-10 .col-md-8 .card-body .card-title").text("Thịt kho trứng cút")
	$("#food-10 .col-md-8 .card-body .describle").text("Thịt kho trứng cút đậm đà với thịt heo ba chỉ béo dai, trứng cút bùi béo ngấm đều gia vị.")
...
$("li#dinner-btn").click(function(){
	...
	$("#food-2 div div img").attr("src", "./img/food/food/ochuong/1-1.jpg")	
	$("#food-2 div div div a").attr("href","./ochuonghapbapsatac.html")
	$("#food-2 .col-md-8 .card-body .card-title").text("Ốc hương hấp bắp sả tắc")
	$("#food-2 .col-md-8 .card-body .describle").text("Ốc hương thì không phải bàn về độ ngon nữa rồi, chế biến món nào cũng ngon hết trơn. Ốc hương hấp bắp sả tắc ăn một lần là nghiện luôn đấy ạ!")
	...
	$("#food-3 .col-md-8 .card-body .date .text-muted").text("Last updated 11/06/2020")

	$("#food-4 div div img").attr("src", "./img/food/bachtuocphomai/bachtuoc.jpeg")	
	$("#food-4 div div div a").attr("href","./pages/bachtuocsotbophomaicay.html")
	$("#food-4 .col-md-8 .card-body .card-title").text("Bạch tuộc sốt bơ phô mai cay")
	$("#food-4 .col-md-8 .card-body .describle").text("Bạch tuộc sốt bơ phô mai cay là món ăn ngon và rất được giới trẻ ưa thích, cũng là một món lai rai lý tưởng cho những ngày mưa lạnh.")
	...
	$("#food-7 .col-md-8 .card-body .date .text-muted").text("Last updated 12/6/2020")
